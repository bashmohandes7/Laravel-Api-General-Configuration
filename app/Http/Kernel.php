...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        // middleware to check password before login to api
        'checkPassword' => \App\Http\Middleware\CheckPassword::class,
        // Middleware to change language of application
        'changeLanguage' => \App\Http\Middleware\ChangeLanguage::class,
        // Check Admin CheckAdminToken
        //'checkAdminToken' => \App\Http\Middleware\CheckAdminToken::class,
        // Dynamic Middleware to access any Guard without make middleware for any one
